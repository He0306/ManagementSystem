    ...
    <el-dialog title="信息" :visible.sync="dialogFormVisible" width="40%" :close-on-click-modal="false">
      <el-form label-width="120px" size="small" style="width: 80%; margin: 0 auto">
        ...
        <el-form-item label="封面">
          <el-upload action="https://hechao.online:8181/file/upload" ref="img" :on-success="handleImgUploadSuccess">
...
export default {
  ...
  methods: {
    buy(row){
      this.request.post("/orders/" + row.id + "/" + 1).then(res=>{
        if (res.code === '200'){
          this.$message({
            type: 'success',
            message: '购买成功，请前往订单页面支付！'
          })
        }else {
          this.$message({
            type: 'error',
    ...
    exp() {
      window.open("http://127.0.0.1:8181/goods/export")
    },
