      ...
      <el-col :span="4">
        <el-card style="width: 300px; height: 300px; color: #333">
          ...
          <div style="padding: 10px 0" v-for="user in users" :key="user.username">
            ...
            <span style="font-size: 12px;color: limegreen; margin-left: 5px" v-if="user.username === chatUser">连接中...</span>
          </div>
        </el-card>
      </el-col>
      <el-col :span="20">
  ...
  methods: {
    ...
    createContent(remoteUser, nowUser, text) {  // 这个方法是用来将 json的聊天消息数据转换成 html的。
      ...
      if (nowUser) { // nowUser 表示是否显示当前用户发送的聊天消息，绿色气泡
        html = "<div class=\"el-row\" style=\"padding: 5px 0\">\n" +
            ...
            "    <img src=\"https://hc-guli.oss-cn-beijing.aliyuncs.com/1.jpg\" style=\"object-fit: cover;\">\n" +
            "  </span>\n" +
            "  </div>\n" +
            "</div>";
    ...
    init() {
      ...
      if (typeof (WebSocket) == "undefined") {
        ...
        console.log("您的浏览器支持WebSocket");
        let socketUrl = "wss://http://127.0.0.1:8080/imserver/" + username;
        if (socket != null) {
          socket.close();
          socket = null;
        }
